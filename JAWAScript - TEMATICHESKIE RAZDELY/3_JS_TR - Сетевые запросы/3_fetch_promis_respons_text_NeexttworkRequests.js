/* JawaScript - 3_fetch_promis_respons_text_NeexttworkRequests               fetch
...
'use strict';
alert("Start 3_fetch_promis_respons_text_NeexttworkRequests");



fetch('https://api.github.com/repos/javascript-tutorial/en.javascript.info/commits')
  .then(response => response.text())                      // прочитать тело ответа как текст
  .then(text => alert(text.slice(0, 50) + '...') );       // [ {  "sha": "9e3fa1351f80cfd6353a778a55b2c86b...
...
/*
Для получения ответа в виде текста используем метод response.text() вместо .json():
*/
