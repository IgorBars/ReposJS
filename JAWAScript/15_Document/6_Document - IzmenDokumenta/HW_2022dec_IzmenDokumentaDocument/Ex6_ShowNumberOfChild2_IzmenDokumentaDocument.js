/* JawaScript - Ex6_ShowNumberOfChild2_IzmenDokumentaDocument         
...
'use strict';
alert("Start Ex6_ShowNumberOfChild2_IzmenDokumentaDocument");
...
function ShowNumberOfChild(container) {   // приймає вузловий елемент-контейнер ul
    ...
    for(let el of container.children) {     // переберемо елементи колекції container
        ...
        let text = `${el.firstChild.data} [${ulinner.children.length}]`;
