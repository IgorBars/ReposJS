/* JawaScript - 2_ZEPOCHKA_PROMISES_zepochkaPromisov
...
// then без new Promise - синхронньій код, передает результат дальше, но не ждет асинхронньіх вьіполнений (ОНИ ИГНОРИРУЮТСЯ)
*/
'use strict';
alert("Start 2_ZEPOCHKA_PROMISES_zepochkaPromisov");
...
// В аргументе обработчика then асинхронную ф-ю можно применить только, обернув ее в промис
