/* JawaScript - 1_MutationObserver_MutationObserverRaznoe               MutationObserver
...
Объекты MutationRecord имеют следующие свойства:
  ...
  - oldValue – предыдущее значение, только для изменений атрибута или текста (НЕ УДАЛЕНИЕ!), 
    если включена соответствующая опция attributeOldValue/characterDataOldValue.
*/

'use strict';
alert("Start 1_MutationObserver_MutationObserverRaznoe");             // СМОТРЕТЬ вівод console.log
